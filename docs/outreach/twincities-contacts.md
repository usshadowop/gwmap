...
|---|---|---|---|
| 3 | Lewis Game Shop (Monticello) | [Contact form](https://www.lewisgameshop.com/contact) / (763) 200-4308 | phone-confirmed 2026-06-27 — carries Warhammer (~100 units); store stamp/loyalty program → category `loyalty`, now confirmed |
