...
- Dreamers Vault Games St. Louis Park  (none)
...
- Van's Comics Games Cards  (unconfirmed)
- Tabletop Citadel  (unconfirmed)
- Petrie's Family Games  (unconfirmed)
- Valkyrie's Loft Toys and Games  (unconfirmed)
- J & J Games N Hobbies  (unconfirmed)
...
### denver (27)
- Warhammer - Square One Denver  (none)
- Warhammer - Boulder  (none)
- The Wizard's Chest  (unconfirmed)
- Timbuk Toys  (unconfirmed)
- Denver Central Games  (unconfirmed)
- Total Escape Games  (unconfirmed)
- Gamers Guild  (unconfirmed)
- Bits & Bobs Toy Shop  (unconfirmed)
- Atomic Goblin Games  (unconfirmed)
- Heart of Gold Games  (unconfirmed)
- Twist & Shout Records  (unconfirmed)
- Bad Habit Hobbies  (unconfirmed)
- Colpar's HobbyTown  (unconfirmed)
- Colpar's HobbyTown  (unconfirmed)
- Colpar HobbyTown - Littleton  (unconfirmed)
- Atomic Games West  (unconfirmed)
- PlayForge  (unconfirmed)
- Coffee Cat Comics  (unconfirmed)
- HobbyTown USA - Westminster  (unconfirmed)
- Crit Castle Games  (unconfirmed)
- Advantage Games  (unconfirmed)
- Mythic Games  (unconfirmed)
- Mind Goblin Games  (unconfirmed)
- Do Gooder Games Cafe  (unconfirmed)
- Collectormania (Gamers Quest)  (unconfirmed)
- Newcastle Comics  (unconfirmed)
- Retro Gaming of Denver  (unconfirmed)

### duluth (4)
- Rogue Robot Games & Comics  (unconfirmed)
- The Loch Cafe  (unconfirmed)
- Level Up Toys Games and Comics  (unconfirmed)
- HobbyTown - Hermantown  (unconfirmed)

### rochester (1)
- Gamez & More  (unconfirmed)

### mankato (3)
- Atlantis Hobby  (unconfirmed)
- The Dork Den  (unconfirmed)
- Mirth Connection  (unconfirmed)
